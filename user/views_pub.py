...
def publish_handler(request):
    ...
    # all_sort= Sort.objects.get(sort_1=sort_1,sort_2=sort_2)
    #return HttpResponse(all_sort.id)
    filename="static/images/"+image.name
